...
namespace UITestProject
{
    ...
    public partial class UIMap
    {
        ...
        public void AssertAssertNoCondational()
        {
            #region Variable Declarations
            WinComboBox uIComboBox1ComboBox = this.UI幫你選股票Window.UIComboBox1Window.UIComboBox1ComboBox;
            WinCell uIVelocityShares3xLongCell = this.UI幫你選股票Window.UIDataGridView1Window.UIDataGridViewTable.UI行0Row2.UIVelocityShares3xLongCell;
            #endregion

            // 确认 “comboBox1” 组合框 等于“23”的“SelectedItem”属性
            Assert.AreEqual(this.AssertAssertNoCondationalExpectedValues.UIComboBox1ComboBoxSelectedItem, uIComboBox1ComboBox.SelectedItem);

            // 确认 “VelocityShares 3x Long Crude Oil ETN” 单元格 等于“VelocityShares 3x Long Crude Oil ETN”的“Value”属性
            Assert.AreEqual(this.AssertAssertNoCondationalExpectedValues.UIVelocityShares3xLongCellValue, uIVelocityShares3xLongCell.Value);
        }
        ...
        public void AssertTestCondtionalByFMC()
        {
            ...
            WinEdit uITextBox3Edit = this.UI幫你選股票Window.UITextBox3Window.UITextBox3Edit;
            WinEdit uITextBox4Edit = this.UI幫你選股票Window.UITextBox4Window.UITextBox4Edit;
            WinCell uI正兴集团Cell = this.UI幫你選股票Window.UIDataGridView1Window.UIDataGridViewTable.UI行0Row3.UI正兴集团Cell;
            WinEdit uIItemEdit = this.UI幫你選股票Window.UIItemWindow.UIItemEdit;
            #endregion

            // 确认 “textBox3” 文本框 等于“0”的“Text”属性
            Assert.AreEqual(this.AssertTestCondtionalByFMCExpectedValues.UITextBox3EditText, uITextBox3Edit.Text);

            // 确认 “textBox4” 文本框 等于“100”的“Text”属性
            Assert.AreEqual(this.AssertTestCondtionalByFMCExpectedValues.UITextBox4EditText, uITextBox4Edit.Text);

            // 确认 “正兴集团” 单元格 等于“正兴集团”的“Value”属性
            Assert.AreEqual(this.AssertTestCondtionalByFMCExpectedValues.UI正兴集团CellValue, uI正兴集团Cell.Value);

            // 确认 文本框 等于“1”的“Text”属性
            Assert.AreEqual(this.AssertTestCondtionalByFMCExpectedValues.UIItemEditText, uIItemEdit.Text);
        }
    ...
    public class AssertTestCondtionalByFMCExpectedValues
    {
        ...
        /// 确认 “正兴集团” 单元格 等于“正兴集团”的“Value”属性
        /// </summary>
        public string UI正兴集团CellValue = "正兴集团";
